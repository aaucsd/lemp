...
from environment.static.panda_env import PandaEnv
...
class panda_moveit(object):
    ...
    def __init__(self):
        super(panda_moveit, self).__init__()
...
def main():
    ...
    try:
        ...
        panda = panda_moveit()
        env = PandaEnv(objects=[VoxelObject(base_orientation=[0, 0, 0, 1], base_position=[0, 1, 1], half_extents=[0.2, 0.2, 0.2])])
        ...
        start = np.concatenate((np.array(panda.move_group.get_current_joint_values()),hand_limits))
        ...
        # print(2)
        # panda.go_to_joint_state(joint_start_state)
        # print(8)
        # panda.go_to_joint_state(2)

        # print(3)
        # cartesian_plan, fraction = panda.plan_cartesian_path()
        ...
        plan.joint_trajectory.joint_names = ['panda_joint1','panda_joint2','panda_joint3','panda_joint4','panda_joint5','panda_joint6','panda_joint7']
