...
class TripleKukaRobot(RobotGroup):

    def __init__(self, base_positions=((0, 0, 0), (0.5, 0, 0), (0, 0.5, 0)),
                       base_orientations=((0, 0, np.sin(np.pi), np.cos(np.pi)), (0, 0, 0, 1), (0, 0, 0, 1)),
        ...
        super(TripleKukaRobot, self).__init__(robots=robots, **kwargs)