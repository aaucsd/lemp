...
class Kuka5Robot(IndividualRobot):

    def __init__(self, base_position=(0, 0, 0), base_orientation=(0, 0, 0, 1),
                 urdf_file="../data/robot/kuka_iiwa/model_5dof.urdf", collision_eps=0.5, **kwargs):
        super(Kuka5Robot, self).__init__(base_position=base_position,
